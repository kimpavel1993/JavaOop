...
public class Main {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            numbersList1.add(random.nextInt(100) + 1);
        }

        hashTable.addAll(numbersList1);

        System.out.println("Таблица с добавленными элементами:");
        System.out.println(hashTable);

        ArrayList<Integer> numbersList2 = new ArrayList<>(Arrays.asList(100, 101, 102, 103, 104, 105, 106, 107, 108, 109));

        System.out.println("Наличие списка в списке: " + hashTable.containsAll(numbersList2));
        System.out.println("Наличие удаленных элементов в списке: " + hashTable.removeAll(numbersList2));

        System.out.println("Список с удаленными элементами:");
        System.out.println(hashTable);

        ArrayList<Integer> numbersList3 = new ArrayList<>(Arrays.asList(1, 2, 3, 4, 5, 6, 7, 8, 9));

        System.out.println("Сохранение только указанных элементов в списке: " + hashTable.retainAll(numbersList3));
