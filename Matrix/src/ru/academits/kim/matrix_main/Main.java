...
public class Main {
    public static void main(String[] args) {
        ...
        double[] vectorComponents1 = {1, 2, 3, 4, 5};

        Vector vector1 = new Vector(vectorComponents1);
        Vector vector2 = new Vector(8, vectorComponents1);
        ...
        double[] vectorComponents2 = {4, 5, 6};

        Vector vector4 = new Vector(vectorComponents2);
